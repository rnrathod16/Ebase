<?php
    ...
    if($num > 0){
        while(($fetch=mysqli_fetch_assoc($result))){
            ...
            $pack=$fetch['pack'];
            $email=$fetch['email'];
            $query = "INSERT INTO `accounts` (`firstname`, `lastname`, `username`, `password`, `pack`, `email`,`time`) VALUES ('$firstname', '$lastname', '$username', '$password', '$pack', '$email', current_timestamp());";
