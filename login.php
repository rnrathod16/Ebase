                          ...
                          $_SESSION['time']=$fetch['time'];
                            ...
                            switch($pack){
                              ...
                              case ($pack=='starter'|| $pack=='Starter'):
                                ...
                                echo "<script>window.location.href='packages/starter.php'</script>";
                                break;
                              
                              case ($pack=='medium'|| $pack=='Medium'):
                                // header("location:packages/medium.php");
                                echo "<script>window.location.href='packages/medium.php'</script>";
                                break;

                                case ($pack=='complete'|| $pack=='Complete'):
                                //   header("location:packages/complete.php");
                                echo "<script>window.location.href='packages/complete.php'</script>";
                                  break;
